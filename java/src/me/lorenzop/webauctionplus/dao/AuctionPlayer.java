...
public class AuctionPlayer {
    ...
    public String getPermsString() {
        String tempPerms = "";
        if (canBuy) {
            tempPerms = addStringSet(tempPerms, "canBuy", ",");
        }
        if (canSell) {
            tempPerms = addStringSet(tempPerms, "canSell", ",");
        }
        if (isAdmin) {
            tempPerms = addStringSet(tempPerms, "isAdmin", ",");
        }
    ...
    public boolean comparePerms(boolean canBuy, boolean canSell, boolean isAdmin) {
        return canBuy == this.canBuy && canSell == this.canSell && isAdmin == this.isAdmin;
    }
