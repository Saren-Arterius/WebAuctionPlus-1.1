...
public class Language {
    ...
    private void loadLanguageFile(String lang) {
        try {
            ...
            final File langFile = new File(plugin.getDataFolder().toString() + File.separator + "languages"
            ...
            final InputStream defaultLangStream = plugin.getClass().getClassLoader()
                    .getResourceAsStream("languages/" + lang + ".yml");
    ...
    public synchronized String getString(String key) {
        if (!isOk) {
            ...
            final String value = langMap.get(key);
